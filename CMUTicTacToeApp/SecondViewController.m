...
- (void)viewDidLoad {
    self.oImg = [UIImage imageNamed:@"eagle.png"];
    self.xImg = [UIImage imageNamed:@"scottie.png"];
...
-(void)displayWinner{
    if([self checkForWin]== YES){
        if(playerToken == 1){
            whoseTurn.text = @"Tartans win!!";
            
        }
        else{whoseTurn.text = @"Eagles win!";
